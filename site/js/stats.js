...
let LeagueDistributionTable = function(mode_id) {
    ...
    o.controls_change = function(name, value) {
        ...
        var stats = sc2.stats.Mode(mode_id).get_last();
