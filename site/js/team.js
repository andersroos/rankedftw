...
export let RankingGraph = function(container_id, team_id, region_id, league_id, mode_id) {
    ...
    o.data_control = new Radio(controls, 'td', 'Data:', [
            {value: 'world', heading: 'World', src: settings.static_url + 'img/regions/world.svg', tooltip: 'Show world ranking for team.'},
            {value: 'region', heading: 'Region', src: settings.static_url + 'img/regions/' + settings.enums_info.region_key_by_ids[region_id] + '.svg', tooltip: 'Show region ranking for team.'},
            {value: 'league', heading: 'League', src: settings.static_url + 'img/leagues/' + settings.enums_info.league_key_by_ids[league_id] + '.svg', tooltip: 'Show league ranking (in region) for team.'},
    ...
    if (settings.enums_info.mode_key_by_ids[mode_id] === '1v1') {
    ...
    o.new_settings = function() {
        ...
        for (let i = start_ranking_index; i <= end_ranking_index; ++i) {
            ...
            if (o.settings.bg === 'leagues') {
                ...
                let ly = 0;
                rev_each(settings.enums_info.league_ranking_ids, function(lid) {
    ...
    o.redraw = function() {
        ...
        if (o.settings.bg) {
            ...
            if (o.settings.bg === 'leagues') {
                ...
                rev_each(settings.enums_info.league_ranking_ids, function(lid, i) {
    ...
    o.update_tooltip = function(m) {
        ...
        $('.version', o.tooltip).text(settings.enums_info.version_name_by_ids[r.version]);
        ...
        $('.league', o.tooltip).empty().append('<img style="margin-bottom: -3px" src="'+ settings.static_url + 'img/leagues/' + settings.enums_info.league_key_by_ids[r.league] + '.svg" height="16px" width="16px"/><span style="margin-bottom: 2px; padding-left: 3px;"> ' + (r.tier + 1) + '</span>');
