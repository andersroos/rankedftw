...
class Test(DjangoTestCase):
    ...
    def test_same_1v1_can_have_multiple_rankings_with_different_races(self):
        ...
        self.process_ladder(league=League.SILVER,
                            members=[
                                gen_member(bid=1, mmr=50, race=Race.ZERG),
        ...
        self.process_ladder(league=League.GOLD,
                            members=[
                                ...
                                gen_member(bid=1, mmr=70, race=Race.TERRAN),
                            ])
        ...
        self.assert_team_ranks(
            self.db.ranking.id,
            dict(region_count=4, region_rank=1, mmr=90, race0=Race.ZERG,    race3=9, league=League.GOLD),
            dict(region_count=4, region_rank=2, mmr=80, race0=Race.PROTOSS, race3=8, league=League.GOLD),
            dict(region_count=4, region_rank=3, mmr=70, race0=Race.TERRAN,  race3=8, league=League.GOLD),
    ...
    def test_same_1v1_can_have_multiple_rankings_with_different_races_among_other_players(self):
        ...
        self.assert_team_ranks(
            ...
            dict(region_count=6, region_rank=4, mmr=50, race0=Race.ZERG,    race3=8, league=League.SILVER),
            dict(region_count=6, region_rank=5, mmr=40, race0=Race.TERRAN,  race3=9, league=League.SILVER),
