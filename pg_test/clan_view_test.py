    ...
    def test_json_get(self):
        ...
        self.assertEqual([
            dict(
                ...
                m0_race="terran",
                m0_name=p1.name,
                m0_bnet_url="http://eu.battle.net/sc2/en/profile/%d/%d/%s/" % (p1.bid, p1.realm, p1.name),
                mmr=3000,
                win_rate=50.0,
                wins=100,
                losses=100,
            ...
            dict(
                ...
                m0_race="zerg",
                m0_name=p2.name,
                m0_bnet_url="http://eu.battle.net/sc2/en/profile/%d/%d/%s/" % (p2.bid, p2.realm, p2.name),
                mmr=2000,
                win_rate=50.0,
                wins=200,
                losses=200,
